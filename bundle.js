...
`,yo=Pe`${ho}`.withBehaviors(co("primary",Pe`${uo}`),co("subtle",Pe`${po}`),co("outline",Pe`${bo}`),co("transparent",Pe`${go}`),It("small",Pe`${mo}`),It("medium",Pe`${fo}`),It("large",Pe`${vo}`));let $o=class extends ro{};$o=t([_({name:"hello-button",template:lo,styles:yo,shadowOptions:{delegatesFocus:!0}})],$o);class xo extends j{constructor(){super(...arguments),this.appearance="filled",this.interactive=!1}}t([O],xo.prototype,"appearance",void 0),t([O({mode:"boolean"})],xo.prototype,"interactive",void 0);const wo=Pe`${Te("block")}:host{contain:content;color:${Ne};border-width:${At};border-style:solid;border-color:none;border-radius:${mt}}:host([interactive]){cursor:pointer}:host([interactive]:hover){box-shadow:${Nt}}::slotted(*){margin:12px}::slotted(fluent-card-preview){margin:0}`.withBehaviors(co("filled",Pe`:host([appearance=filled]){background-color:${_e};border-color:${ht};box-shadow:${Tt}}:host([appearance=filled][interactive]:hover){background-color:${Ue};border-color:${ut}}:host([appearance=filled][interactive]:active){background-color:${We}}`),co("filled-alternative",Pe`:host([appearance=filled-alternative]){background-color:${"var(--colorNeutralBackground2)"};border-color:${ht};box-shadow:${Tt}}:host([appearance=filled-alternative][interactive]:hover){background-color:${"var(--colorNeutralBackground2Hover)"};border-color:${ut}}:host([appearance=filled-alternative][interactive]:active){background-color:${"var(--colorNeutralBackground2Pressed)"}}`),co("outline",Pe`:host([appearance=outline]){background-color:${Xe};border-color:${nt}}:host([appearance=outline][interactive]:hover){border-color:${lt}}:host([appearance=outline][interactive]:active){background-color:${ct}}:host([appearance=outline]),:host([appearance=outline][interactive]),:host([appearance=outline][interactive]:hover){box-shadow:none}`),co("subtle",Pe`:host([appearance=subtle]){background-color:${Ge};border-color:${ht}}:host([appearance=subtle][interactive]:hover){border-color:${Ke}}:host([appearance=subtle][interactive]:active){background-color:${Qe}}:host([appearance=subtle]),:host([appearance=subtle][interactive]),:host([appearance=subtle][interactive]:hover){box-shadow:none}`));let ko=class extends xo{};ko=t([_({name:"fluent-card",template:Be`<template role="group"><slot></slot></template>`,styles:wo})],ko);class Co extends j{}const Bo=Be`<slot></slot><slot name="action"></slot>`,So=Pe`${Te("flex")}:host{display:flex;flex-direction:row;gap:12px}::slotted([slot=action]){margin-inline-start:auto}`;let zo=class extends Co{};zo=t([_({name:"fluent-card-footer",template:Bo,styles:So})],zo);class Fo extends j{}const Po=Be`<template><slot name="image"></slot><div class="text-container" part="text-container"><slot></slot><slot name="description"></slot></div><slot name="action"></slot></template>`,To=Pe`${Te("flex")}:host{display:flex;flex-direction:row;align-items:center;gap:12px;height:32px}::slotted([slot=image]),::slotted(img){min-width:24px;min-height:24px;max-width:32px;max-height:32px}.text-container{display:flex;flex-direction:column;flex-grow:1;height:inherit}.text-container>*{height:50%}`;let No=class extends Fo{};No=t([_({name:"fluent-card-header",template:Po,styles:To})],No);class Ao extends j{}const Oo=Be`<slot></slot><slot name="logo"></slot>`,Eo=Pe`${Te("block")}:host{position:relative}::slotted(*){display:block}::slotted([slot=logo]){position:absolute;bottom:12px;left:12px;width:32px;height:32px}`;let Lo=class extends Ao{};Lo=t([_({name:"fluent-card-preview",template:Oo,styles:Eo})],Lo);const Vo=Be`<template role="checkbox" aria-checked="${e=>e.checked}" aria-required="${e=>e.required}" aria-disabled="${e=>e.disabled}" aria-readonly="${e=>e.readOnly}" tabindex="${e=>e.disabled?null:0}" @keypress="${(e,t)=>e.keypressHandler(t.event)}" @click="${(e,t)=>e.clickHandler(t.event)}" class="${e=>e.indeterminate?"indeterminate":""}"><div part="control" class="control"><slot name="checked-indicator"><svg width="16" height="16" xmlns="http://www.w3.org/2000/svg" aria-hidden="true"><path d="M13.86 3.66a.5.5 0 01-.02.7l-7.93 7.48a.6.6 0 01-.84-.02L2.4 9.1a.5.5 0 01.72-.7l2.4 2.44 7.65-7.2a.5.5 0 01.7.02z"/></svg></slot><slot name="indeterminate-indicator"><svg width="12" height="12" viewBox="0 0 12 12" xmlns="http://www.w3.org/2000/svg" aria-hidden="true"><path d="M2 4c0-1.1.9-2 2-2h4a2 2 0 012 2v4a2 2 0 01-2 2H4a2 2 0 01-2-2V4z"></path></svg></slot></div><slot></slot></template>`;class Io extends j{}class Ro extends(function(e){class t extends(eo(e)){}class o extends t{constructor(...e){super(e),this.dirtyChecked=!1,this.checkedAttribute=!1,this.checked=!1,this.dirtyChecked=!1}checkedAttributeChanged(){this.defaultChecked=this.checkedAttribute}defaultCheckedChanged(){this.dirtyChecked||(this.checked=this.defaultChecked,this.dirtyChecked=!1)}checkedChanged(e,t){this.dirtyChecked||(this.dirtyChecked=!0),this.currentChecked=this.checked,this.updateForm(),this.proxy instanceof HTMLInputElement&&(this.proxy.checked=this.checked),void 0!==e&&this.$emit("change"),this.validate()}currentCheckedChanged(e,t){this.checked=this.currentChecked}updateForm(){const e=this.checked?this.value:null;this.setFormValue(e,e)}connectedCallback(){super.connectedCallback(),this.updateForm()}formResetCallback(){super.formResetCallback(),this.checked=!!this.checkedAttribute,this.dirtyChecked=!1}}return O({attribute:"checked",mode:"boolean"})(o.prototype,"checkedAttribute"),O({attribute:"current-checked",converter:T})(o.prototype,"currentChecked"),$(o.prototype,"defaultChecked"),$(o.prototype,"checked"),o}(Io)){constructor(){super(...arguments),this.proxy=document.createElement("input")}}class Mo extends Ro{constructor(){super(),this.size="medium",this.labelBefore=!1,this.initialValue="on",this.indeterminate=!1,this.keypressHandler=e=>{" "===e.key&&(this.checked=!this.checked)},this.clickHandler=e=>{this.disabled||this.readOnly||(this.checked=!this.checked)},this.proxy.setAttribute("type","checkbox")}readOnlyChanged(){this.proxy instanceof HTMLInputElement&&(this.proxy.readOnly=this.readOnly)}}let Ho;t([O],Mo.prototype,"size",void 0),t([O({attribute:"label-before",mode:"boolean"})],Mo.prototype,"labelBefore",void 0),t([O({attribute:"readonly",mode:"boolean"})],Mo.prototype,"readOnly",void 0),t([$],Mo.prototype,"defaultSlottedNodes",void 0),t([$],Mo.prototype,"indeterminate",void 0);const Do=function(){if("boolean"==typeof Ho)return Ho;if("undefined"==typeof window||!window.document||!window.document.createElement)return Ho=!1,Ho;const e=document.createElement("style"),t=function(){const e=document.querySelector('meta[property="csp-nonce"]');return e?e.getAttribute("content"):null}();null!==t&&e.setAttribute("nonce",t),document.head.appendChild(e);try{e.sheet.insertRule("foo:focus-visible {color:inherit}",0),Ho=!0}catch(e){Ho=!1}finally{document.head.removeChild(e)}return Ho}()?"focus-visible":"focus",qo="12px",jo="16px",_o="20px",Uo=Pe`
    ${Te("inline-flex")} :host {
      align-items: center;
      height: 32px;
      outline: none;
    ...
    :host([label-before]) ::slotted(*) {
        ...
        margin-inline-end: ${qo};
    }
  `;let Wo=class extends Mo{};var Go;Wo=t([_({name:"fluent-checkbox",template:Vo,styles:Uo})],Wo),function(e){e.separator="separator",e.presentation="presentation"}(Go||(Go={}));class Ko extends j{constructor(){super(...arguments),this.role=Go.separator,this.alignContent="center",this.inset=!1,this.vertical=!1}}t([O],Ko.prototype,"role",void 0),t([O],Ko.prototype,"appearance",void 0),t([O({attribute:"align-content"})],Ko.prototype,"alignContent",void 0),t([O({mode:"boolean"})],Ko.prototype,"inset",void 0),t([O({mode:"boolean"})],Ko.prototype,"vertical",void 0);const Qo=Be`<template class="${e=>e.hasChildNodes()?"children":"childless"}" role="${e=>e.role}" aria-orientation="${e=>e.vertical?"vertical":"horizontal"}">${Se((e=>e.hasChildNodes()),Be`<div class="wrapper" part="wrapper"><slot></slot></div>`)}</template>`,Xo="12px",Yo="12px",Jo="8px",Zo="8px;";function er(e,t){return new Vt("vertical",e,t)}const tr=Pe`${Te("flex")}:host{align-items:center;box-sizing:border-box;flex-direction:row;flex-grow:1;position:relative;font-family:${yt};font-size:${xt};font-weight:${St};line-height:${Ft};text-align:center;color:${Ae}}:host::after,:host::before{box-sizing:border-box;display:flex;flex-grow:1}:host::after,:host::before{border-color:${"var(--colorNeutralStroke2)"}}:host([align-content=start])::after{content:""}:host([align-content=center])::after,:host([align-content=center])::before{content:""}:host([align-content=end])::before{content:""}:host([align-content].childless)::before{margin-bottom:0;margin-right:0}:host([align-content].childless)::after{margin-left:0;margin-top:0}`.withBehaviors(co("brand",Pe`:host([appearance=brand]){color:${"var(--colorBrandForeground1)"}}:host([appearance=brand])::after,:host([appearance=brand])::before{border-color:${"var(--colorBrandStroke1)"}}`),co("subtle",Pe`:host([appearance=subtle])::after,:host([appearance=subtle])::before{border-color:${"var(--colorNeutralStroke3)"}}`),co("strong",Pe`:host([appearance=strong])::after,:host([appearance=strong])::before{border-color:${nt}}`),er(!1,Pe`:host{width:100%}:host::after,:host::before{border-top-style:solid;border-top-width:${At};min-width:${Zo}}:host([inset]){padding-inline:${Yo}}:host([align-content=start])::before{content:"";margin-right:${Xo};max-width:${Jo}}:host([align-content=start])::after{margin-left:${Xo}}:host([align-content=center])::before{margin-right:${Xo}}:host([align-content=center])::after{margin-left:${Xo}}:host([align-content=end])::after{content:"";margin-left:${Xo};max-width:${Jo}}:host([align-content=end])::before{margin-right:${Xo}}`),er(!0,Pe`:host([vertical]){flex-direction:column;min-height:20px}:host([vertical])::after,:host([vertical])::before{border-right-style:solid;border-right-width:${At};min-height:${Zo}}:host([inset]){margin-block:${Yo}}:host([vertical].children){min-height:84px}:host([align-content=start])::before{content:"";margin-bottom:${Xo};max-height:${Jo}}:host([align-content=start])::after{margin-top:${Xo}}:host([align-content=center])::before{margin-bottom:${Xo}}:host([align-content=center])::after{margin-top:${Xo}}:host([align-content=end])::after{content:"";margin-top:${Xo};max-height:${Jo}}:host([align-content=end])::before{margin-bottom:${Xo}}`));let or=class extends Ko{};or=t([_({name:"fluent-divider",template:Qo,styles:tr})],or);class rr extends j{constructor(){super(...arguments),this.handleUnsupportedDelegatesFocus=()=>{var e;window.ShadowRoot&&!window.ShadowRoot.prototype.hasOwnProperty("delegatesFocus")&&(null===(e=this.$fastController.definition.shadowOptions)||void 0===e?void 0:e.delegatesFocus)&&(this.focus=()=>{this.control.focus()})},this.inline=!1,this.disabled=!1,this.disabledFocusable=!1}connectedCallback(){super.connectedCallback(),this.handleUnsupportedDelegatesFocus()}handleDisabledClick(e){if(!this.disabled&&!this.disabledFocusable)return!0;e.preventDefault()}handleDisabledKeydown(e){if(!this.disabled&&!this.disabledFocusable||"Enter"!==e.key&&" "!==e.key)return!0;e.preventDefault(),e.stopPropagation()}}t([O],rr.prototype,"download",void 0),t([O],rr.prototype,"href",void 0),t([O],rr.prototype,"hreflang",void 0),t([O],rr.prototype,"ping",void 0),t([O],rr.prototype,"referrerpolicy",void 0),t([O],rr.prototype,"rel",void 0),t([O],rr.prototype,"target",void 0),t([O],rr.prototype,"type",void 0),t([O({attribute:"aria-expanded",mode:"fromView"})],rr.prototype,"ariaExpanded",void 0),t([$],rr.prototype,"defaultSlottedContent",void 0),t([O],rr.prototype,"appearance",void 0),t([O({mode:"boolean"})],rr.prototype,"inline",void 0),t([O({mode:"boolean"})],rr.prototype,"disabled",void 0),t([O({attribute:"disabledfocusable",mode:"boolean"})],rr.prototype,"disabledFocusable",void 0),Gt(rr,Xt);const sr=Be`<a class="base" part="base" download="${e=>e.download}" tabindex="${e=>e.disabledFocusable?"0":e.disabled?"-1":!!e.tabIndex||void 0}" href="${e=>e.href}" hreflang="${e=>e.hreflang}" ping="${e=>e.ping}" referrerpolicy="${e=>e.referrerpolicy}" rel="${e=>e.rel}" target="${e=>e.target}" type="${e=>e.type}" aria-atomic="${e=>e.ariaAtomic}" aria-busy="${e=>e.ariaBusy}" aria-controls="${e=>e.ariaControls}" aria-current="${e=>e.ariaCurrent}" aria-describedby="${e=>e.ariaDescribedby}" aria-details="${e=>e.ariaDetails}" aria-disabled="${e=>e.disabled||e.disabledFocusable||e.ariaDisabled}" aria-errormessage="${e=>e.ariaErrormessage}" aria-expanded="${e=>e.ariaExpanded}" aria-flowto="${e=>e.ariaFlowto}" aria-haspopup="${e=>e.ariaHaspopup}" aria-hidden="${e=>e.ariaHidden}" aria-invalid="${e=>e.ariaInvalid}" aria-keyshortcuts="${e=>e.ariaKeyshortcuts}" aria-label="${e=>e.ariaLabel}" aria-labelledby="${e=>e.ariaLabelledby}" aria-live="${e=>e.ariaLive}" aria-owns="${e=>e.ariaOwns}" aria-relevant="${e=>e.ariaRelevant}" aria-roledescription="${e=>e.ariaRoledescription}" @click="${(e,t)=>e.handleDisabledClick(t.event)}" @keydown="${(e,t)=>e.handleDisabledKeydown(t.event)}" ${ao("control")}><slot></slot></a>`,ar=Pe`${Te("inline")}:host .base{background-color:transparent;border-top-style:none;border-left-style:none;border-right-style:none;border-bottom-color:transparent;border-bottom-style:solid;border-bottom-width:${At};box-sizing:border-box;color:${He};cursor:pointer;font-family:${yt};font-size:${wt};font-weight:${St};margin:0;padding:0;overlow:inherit;text-align:left;text-decoration-line:none;text-overflow:inherit;user-select:text}:host(:hover) .base{border-bottom-color:${De};color:${De}}:host(:active) .base{border-bottom-color:${qe};color:${qe}}:host([inline]),:host([inline]) .base{font-size:inherit;line-height:inherit}:host([disabled]) .base,:host([disabledfocusable]) .base{border-bottom-color:transparent;color:${Me};cursor:not-allowed}:host([inline]) .base{border-bottom-color:${He}}:host([inline][disabled]) .base,:host([inline][disabledfocusable]) .base{border-bottom-color:${Me}}`.withBehaviors(co("subtle",Pe`:host([appearance=subtle]) .base{color:${Ae}}:host([appearance=subtle]:hover) .base{border-bottom-color:${Oe};color:${Oe}}:host([appearance=subtle]:active) .base{border-bottom-color:${Ee};color:${Ee}}:host([inline][appearance=subtle]) .base{border-bottom-color:${Ae}}:host([appearance=subtle][disabled]) .base,:host([appearance=subtle][disabledfocusable]) .base{border-bottom-color:transparent;color:${Me}}:host([appearance=subtle][inline][disabled]) .base,:host([appearance=subtle][inline][disabledfocusable]) .base{border-bottom-color:${Me}}`));let ir=class extends rr{};ir=t([_({name:"fluent-link",template:sr,styles:ar,shadowOptions:{delegatesFocus:!0}})],ir);const nr=Be`<template aria-hidden="true"><slot name="${e=>e.getSlotInfo().name}">${e=>Be`${e.getSlotInfo().icon}`}</slot></template>`,lr='<svg height="16" viewBox="0 0 16 16" width="16" xmlns="http://www.w3.org/2000/svg"><path d="m10.7071 5.29289c.3905.39053.3905 1.02369 0 1.41422l-1.29289 1.29289 1.29289 1.29289c.3905.39053.3905 1.02371 0 1.41421s-1.02368.3905-1.41421 0l-1.29289-1.29289-1.29289 1.29289c-.39053.3905-1.02369.3905-1.41422 0-.39052-.3905-.39052-1.02368 0-1.41421l1.2929-1.29289-1.2929-1.29289c-.39052-.39053-.39052-1.02369 0-1.41422.39053-.39052 1.02369-.39052 1.41422 0l1.29289 1.2929 1.29289-1.2929c.39053-.39052 1.02371-.39052 1.41421 0z"/><path d="m0 8c0-4.41828 3.58172-8 8-8 4.4183 0 8 3.58172 8 8 0 4.4183-3.5817 8-8 8-4.41828 0-8-3.5817-8-8zm8-6c-3.31371 0-6 2.68629-6 6 0 3.3137 2.68629 6 6 6 3.3137 0 6-2.6863 6-6 0-3.31371-2.6863-6-6-6z"/><</svg>',cr='<svg height="16" viewBox="0 0 16 16" width="16" xmlns="http://www.w3.org/2000/svg"><path d="m8.2071 6.20736c.39053-.39052.39054-1.02368.00002-1.41421s-1.02368-.39054-1.41422-.00002l-2.5 2.49991c-.18754.18754-.2929.44189-.2929.70711s.10535.51958.29289.70712l2.5 2.50003c.39053.3905 1.02369.3905 1.41422 0 .39052-.3906.39052-1.0237 0-1.41425l-.7929-.79289h3.58579c.5523 0 1-.44772 1-1s-.4477-1-1-1h-3.58573z"/><path d="m8 0c-4.41828 0-8 3.58172-8 8 0 4.4183 3.58172 8 8 8 4.4183 0 8-3.5817 8-8 0-4.41828-3.5817-8-8-8zm-6 8c0-3.31371 2.68629-6 6-6 3.3137 0 6 2.68629 6 6 0 3.3137-2.6863 6-6 6-3.31371 0-6-2.6863-6-6z"/></svg>',dr='<svg height="16" viewBox="0 0 16 16" width="16" xmlns="http://www.w3.org/2000/svg"><path d="m8 2c-3.31371 0-6 2.68629-6 6 0 3.3137 2.68629 6 6 6 3.3137 0 6-2.6863 6-6 0-3.31371-2.6863-6-6-6zm-8 6c0-4.41828 3.58172-8 8-8 4.4183 0 8 3.58172 8 8 0 4.4183-3.5817 8-8 8-4.41828 0-8-3.5817-8-8z"/></svg>';class hr extends j{constructor(){super(...arguments),this.status="available",this.size="medium",this.outofoffice=!1}getSlotInfo(){if(this.outofoffice)switch(this.status){case"available":return{name:this.status,icon:'<svg height="16" viewBox="0 0 16 16" width="16" xmlns="http://www.w3.org/2000/svg"><path d="m11.7071 6.70711c.3905-.39053.3905-1.02369 0-1.41422-.3905-.39052-1.0237-.39052-1.4142 0l-3.2929 3.2929-1.29289-1.2929c-.39053-.39052-1.02369-.39052-1.41422 0-.39052.39053-.39052 1.02369 0 1.41422l2 1.99999c.39053.3905 1.02369.3905 1.41422 0z"/><path d="m0 8c0-4.41828 3.58172-8 8-8 4.4183 0 8 3.58172 8 8 0 4.4183-3.5817 8-8 8-4.41828 0-8-3.5817-8-8zm8-6c-3.31371 0-6 2.68629-6 6 0 3.3137 2.68629 6 6 6 3.3137 0 6-2.6863 6-6 0-3.31371-2.6863-6-6-6z"/></svg>'};case"away":return{name:this.status,icon:lr};case"busy":return{name:this.status,icon:'<svg height="16" viewBox="0 0 16 16" width="16" xmlns="http://www.w3.org/2000/svg"><path d="m8 2c-3.31371 0-6 2.68629-6 6 0 3.3137 2.68629 6 6 6 3.3137 0 6-2.6863 6-6 0-3.31371-2.6863-6-6-6zm-8 6c0-4.41828 3.58172-8 8-8 4.4183 0 8 3.58172 8 8 0 4.4183-3.5817 8-8 8-4.41828 0-8-3.5817-8-8z"/></svg>'};case"donotdisturb":return{name:this.status,icon:'<svg height="16" viewBox="0 0 16 16" width="16" xmlns="http://www.w3.org/2000/svg"><path d="m5.25 7c-.55228 0-1 .44772-1 1s.44772 1 1 1h5.5c.5523 0 1-.44772 1-1s-.4477-1-1-1z"/><path d="m0 8c0-4.41828 3.58172-8 8-8 4.4183 0 8 3.58172 8 8 0 4.4183-3.5817 8-8 8-4.41828 0-8-3.5817-8-8zm8-6c-3.31371 0-6 2.68629-6 6 0 3.3137 2.68629 6 6 6 3.3137 0 6-2.6863 6-6 0-3.31371-2.6863-6-6-6z"/></svg>'};case"offline":case"outofoffice":return{name:this.status,icon:cr};default:return{name:"unknown",icon:dr}}else switch(this.status){case"available":return{name:this.status,icon:'<svg height="16" viewBox="0 0 16 16" width="16" xmlns="http://www.w3.org/2000/svg"><path d="m8 16c4.4183 0 8-3.5817 8-8 0-4.41828-3.5817-8-8-8-4.41828 0-8 3.58172-8 8 0 4.4183 3.58172 8 8 8zm3.7069-9.29261-4.00329 4.00001c-.18766.1875-.44214.2928-.70742.2926-.26529-.0002-.51964-.1057-.70707-.2935l-1.99679-1.99996c-.39021-.39084-.38971-1.024.00113-1.41421s1.024-.38971 1.41421.00113l1.28998 1.29205 3.29555-3.2929c.3907-.39037 1.0239-.39011 1.4142.00057.3904.39068.3901 1.02385-.0005 1.41421z"></svg>'};case"away":return{name:this.status,icon:'<svg height="16" viewBox="0 0 16 16" width="16" xmlns="http://www.w3.org/2000/svg"><path d="m8 16c4.4183 0 8-3.5817 8-8 0-4.41828-3.5817-8-8-8-4.41828 0-8 3.58172-8 8 0 4.4183 3.58172 8 8 8zm.5-11.5v3.01937l2.1247 1.69976c.4313.34501.5012.97427.1562 1.40557s-.97433.5012-1.40559.1562l-2.5-2.00003c-.23722-.18977-.37531-.47709-.37531-.78087v-3.5c0-.55228.44772-1 1-1 .55229 0 1 .44772 1 1z"/></svg>'};case"busy":return{name:this.status,icon:'<svg height="16" viewBox="0 0 16 16" width="16" xmlns="http://www.w3.org/2000/svg"><path d="m16 8c0 4.4183-3.5817 8-8 8-4.41828 0-8-3.5817-8-8 0-4.41828 3.58172-8 8-8 4.4183 0 8 3.58172 8 8z"/></svg>'};case"donotdisturb":return{name:this.status,icon:'<svg height="16" viewBox="0 0 16 16" width="16" xmlns="http://www.w3.org/2000/svg"><path d="m8 16c4.4183 0 8-3.5817 8-8 0-4.41828-3.5817-8-8-8-4.41828 0-8 3.58172-8 8 0 4.4183 3.58172 8 8 8zm-2.75098-9h5.50088c.5523 0 1 .44772 1 1 0 .55229-.4477 1-1 1h-5.50088c-.55228 0-1-.44771-1-1 0-.55228.44772-1 1-1z"/></svg>'};case"offline":return{name:this.status,icon:lr};case"outofoffice":return{name:this.status,icon:cr};default:return{name:"unknown",icon:dr}}}}t([O],hr.prototype,"status",void 0),t([O],hr.prototype,"size",void 0),t([O({mode:"boolean"})],hr.prototype,"outofoffice",void 0);const ur=Pe`${Te("inline-flex")}:host{box-sizing:border-box;align-items:center;justify-content:center;border-radius:50%;background-color:${_e}}:host([outofoffice]){color:${_e}}:host([status=away]){color:${bt}}:host([status=available]){color:${pt}}:host([outofoffice][status=offline]),:host([status=offline]){color:${Re}}:host([outofoffice][status=outofoffice]),:host([status=outofoffice]){color:${"var(--colorPaletteBerryForeground3)"}}:host([outofoffice][status=available]){color:${pt}}:host([outofoffice][status=away]){color:${bt}}:host([outofoffice][status=busy]),:host([outofoffice][status=donotdisturb]),:host([outofoffice][status=unknown]),:host([status=busy]),:host([status=donotdisturb]),:host([status=unknown]){color:${"var(--colorPaletteRedBackground3)"}}::slotted(*),slot{fill:currentColor}`.withBehaviors(It("tiny",Pe`::slotted(svg),:host([size=tiny]) svg{width:6px;height:6px}`),It("extra-small",Pe`::slotted(svg),:host([size=extra-small]) svg{width:10px;height:10px}`),It("small",Pe`::slotted(svg),:host([size=small]) svg{width:12px;height:12px}`),It("medium",Pe`::slotted(svg),:host([size=medium]) svg{width:16px;height:16px}`),It("large",Pe`::slotted(svg),:host([size=large]) svg{width:20px!important;height:20px!important}`),It("extra-large",Pe`::slotted(svg),:host([size=extra-large]) svg{width:28px!important;height:28px!important}`));let pr=class extends hr{};pr=t([_({name:"fluent-presence-badge",template:nr,styles:ur})],pr);const br=Be`<button class="base" part="base" ?autofocus="${e=>e.autofocus}" ?disabled="${e=>e.disabled}" tabindex="${e=>e.disabledFocusable?"0":!!e.tabIndex||void 0}" form="${e=>e.formId}" formaction="${e=>e.formaction}" formenctype="${e=>e.formenctype}" formmethod="${e=>e.formmethod}" formnovalidate="${e=>e.formnovalidate}" formtarget="${e=>e.formtarget}" name="${e=>e.name}" type="${e=>e.type}" value="${e=>e.value}" aria-atomic="${e=>e.ariaAtomic}" aria-busy="${e=>e.ariaBusy}" aria-controls="${e=>e.ariaControls}" aria-current="${e=>e.ariaCurrent}" aria-describedby="${e=>e.ariaDescribedby}" aria-details="${e=>e.ariaDetails}" aria-disabled="${e=>!0===e.disabledFocusable?"true":e.ariaDisabled}" aria-errormessage="${e=>e.ariaErrormessage}" aria-expanded="${e=>e.ariaExpanded}" aria-flowto="${e=>e.ariaFlowto}" aria-haspopup="${e=>e.ariaHaspopup}" aria-hidden="${e=>e.ariaHidden}" aria-invalid="${e=>e.ariaInvalid}" aria-keyshortcuts="${e=>e.ariaKeyshortcuts}" aria-label="${e=>e.ariaLabel}" aria-labelledby="${e=>e.ariaLabelledby}" aria-live="${e=>e.ariaLive}" aria-owns="${e=>e.ariaOwns}" aria-pressed="${e=>e.checked||e.ariaPressed}" aria-relevant="${e=>e.ariaRelevant}" aria-roledescription="${e=>e.ariaRoledescription}" @keypress="${(e,t)=>e.keypressHandler(t.event)}" @click="${(e,t)=>e.clickHandler(t.event)}" ${ao("control")}><slot name="start"></slot><slot ${no("defaultSlottedContent")}></slot><slot name="end"></slot></button>`;class gr extends ro{constructor(){super(),this.dirtyChecked=!1,this.checkedAttribute=!1,this.checked=!1,this.currentChecked=!1,this.keypressHandler=e=>{if(!this.disabled&&!this.disabledFocusable)switch(e.key){case"Enter":case" ":this.checked=!this.checked}},this.clickHandler=e=>{this.disabled||this.disabledFocusable||(this.checked=!this.checked)},this.dirtyChecked=!1}checkedAttributeChanged(){this.defaultChecked=this.checkedAttribute}defaultCheckedChanged(){this.dirtyChecked||(this.checked=this.defaultChecked,this.dirtyChecked=!1)}checkedChanged(e,t){this.dirtyChecked||(this.dirtyChecked=!0),this.currentChecked=this.checked,void 0!==e&&this.$emit("change")}currentCheckedChanged(e,t){this.checked=this.currentChecked}}t([O({attribute:"checked",mode:"boolean"})],gr.prototype,"checkedAttribute",void 0),t([$],gr.prototype,"defaultChecked",void 0),t([$],gr.prototype,"checked",void 0),t([O({attribute:"current-checked",mode:"boolean"})],gr.prototype,"currentChecked",void 0);const mr=Pe`${ho}:host([current-checked]) .base{background-color:${"var(--colorNeutralBackground1Selected)"};border-color:${nt};color:${Ne};border-width:${At}}:host([current-checked]:hover) .base{background-color:${Ue};border-color:${lt};color:${Ne}}:host([current-checked]:active) .base{background-color:${We};border-color:${ct};color:${Ne}}`.withBehaviors(co("primary",Pe`${uo}:host([current-checked][appearance=primary]) .base{background-color:${"var(--colorBrandBackgroundSelected)"};border-color:transparent;color:${je}}:host([current-checked][appearance=primary]:hover) .base{background-color:${tt}}:host([current-checked][appearance=primary]:active) .base{background-color:${ot}}`),co("subtle",Pe`${po}:host([current-checked][appearance=subtle]) .base{background-color:${"var(--colorSubtleBackgroundSelected)"};border-color:transparent;color:${Ie}}:host([current-checked][appearance=subtle]:hover) .base{background-color:${Ke};color:${Le}}:host([current-checked][appearance=subtle]:active) .base{background-color:${Qe};color:${Ve}}`),co("outline",Pe`${bo}:host([current-checked][appearance=outline]) .base{background-color:${Ze}}:host([current-checked][appearance=outline]:hover) .base{background-color:${Ye}}:host([current-checked][appearance=outline]:active) .base{background-color:${Je}}`),co("transparent",Pe`${go}:host([current-checked][appearance=transparent]) .base{background-color:${Ze};border-color:transparent;color:${Ie}}:host([current-checked][appearance=transparent]:hover) .base{background-color:${Ye};color:${Le}}:host([current-checked][appearance=transparent]:active) .base{background-color:${Je};color:${Ve}}`),It("small",Pe`${mo}`),It("medium",Pe`${fo}`),It("large",Pe`${vo}`));let fr=class extends gr{};var vr;fr=t([_({name:"fluent-toggle-button",template:br,styles:mr,shadowOptions:{delegatesFocus:!0}})],fr),function(e){e.Button="button",e.Mixed="mixed",e.Card="card"}(vr||(vr={}));const yr='<hello-button appearance="primary">Button</hello-button>',$r="<fluent-card>I'm a Card</fluent-card>",xr=yr,wr=Be`<div id="container">${Se((e=>e.repeatNum),(e=>e.componentTemplate))}</div>`;let kr=class extends j{constructor(){super(...arguments),this.repeatNum=0,this.component="",this.templatestr=xr,this.componentTemplate=Be``}connectedCallback(){super.connectedCallback();const e=new URLSearchParams(document.location.search);this.component=e.get("component");const t=e.get("repeatNum");switch(t&&(this.repeatNum=parseInt(t)),this.component){case vr.Button:this.templatestr=yr;break;case vr.Card:this.templatestr=$r;break;default:this.templatestr=yr}const o=this.templatestr.repeat(this.repeatNum);this.componentTemplate=Be`${o}`}};t([$],kr.prototype,"repeatNum",void 0),t([$],kr.prototype,"component",void 0),kr=t([_({name:"component-container",template:wr})],kr)})();